  ...
  @csrf        
    <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input type="text" name="email" class="form-control" placeholder="أسم المستخدم" autofocus>
        </div>
        @if ($errors->has('email'))
            <span class="invalid-feedback" role="alert">
                <strong>{{ $errors->first('email') }}</strong>
        ...
        <label class="checkbox ">
            ...
            <span class=""> <a href="#"> نسيت كلمة المرور ؟</a></span>
        </label>
        <button class="btn btn-primary btn-lg btn-block" type="submit">دخول</button>
        <a class="btn btn-info btn-lg btn-block" href="{{route('register')}}">تسجيل جديد</a>
    </div>
  </form>
</div>
